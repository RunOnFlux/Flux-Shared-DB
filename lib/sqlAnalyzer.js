...
function cleanUP(sql) {
  ...
  if (sql.startsWith('/*!40101 SET character_set_client = utf8 */')) sql = '/*!40101 SET character_set_client = utf8mb4 */';
  // eslint-disable-next-line no-param-reassign
  if (sql.startsWith('/*!40101 SET NAMES utf8 */')) sql = '/*!40101 SET NAMES utf8mb4 */';
  if (sql.startsWith('--')) {
    // eslint-disable-next-line no-param-reassign
